...
{
    public class TwistPublisherDamien : UnityPublisher<MessageTypes.Geometry.Twist>
    {
        public TurtleBotController TurtleBotController;
        ...
        private void UpdateMessage()
        {
            ...
            Vector3 linearVelocity = TurtleBotController.velocityRobot;
            Vector3 angularVelocity = TurtleBotController.angularVelocityRobot;
